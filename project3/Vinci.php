...
<head> 
	<meta charset="utf-8">
	<title>Sichen Pan, CSC 170 Project 3</title>
...
<body>
	...
	<main class="maincontent">
		...
		<section class="s3">
			...
			<figure>
  				...
  				<figcaption>Annunciation (1475–1480), Uffizi, is thought to be Leonardo's earliest complete work</figcaption>
			</figure>
			<div class="p3">
		...
		<section class="s4">
			...
			<div>
				...
				<p>Other characteristics of the painting are the unadorned dress, in which the eyes and hands have no competition from other details; the dramatic landscape background, in which the world seems to be in a state of flux; the subdued colouring; and the extremely smooth nature of the painterly technique, employingoilslaid on much like?tempera, and blended on the surface so that the brushstrokes are indistinguishable. Vasari expressed the opinion that the manner of painting would make even "the most confident master ... despair and lose heart." The perfect state of preservation and the fact that there is no sign of repair or overpainting is rare in a panel painting of this date.</p>	
				
			</div>
			<p class="p4">In the painting Virgin and Child with St. Anne, the composition again picks up the theme of figures in a landscape, which Wasserman describes as "breathtakingly beautiful"?and harkens back to the St Jerome picture with the figure set at an oblique angle. What makes this painting unusual is that there are two obliquely set figures superimposed. Mary is seated on the knee of her mother, St Anne. She leans forward to restrain the Christ Child as he plays roughly with a lamb, the sign of his own impending sacrifice. This painting, which was copied many times, influenced Michelangelo, Raphael, and Andrea del Sarto, and through them Pontormo and Correggio. The trends in composition were adopted in particular by the Venetian painters Tintoretto and Veronese.</p>
		</section>
	</main>	
	<aside>
			<h2>List of Manuscripts</h2>
			<ul class="manuscripts">
				<li>Codex Atlanticus</li>
				<li>Codex Windsor</li>
				<li>Codex Arundel</li>
				<li>Codex Trivulzianus</li>
				<li>Codex Forster</li>
				<li>Paris Manuscripts</li>
				<li>Codex Madrid</li>
				<li>Codex Ashburnham</li>
				<li>Codex on the Flight of Birds</li>
				<li>Codex Leicester</li>
				<li>Codex Urbinas</li>
			</ul>
	</aside>
		
	<aside>
		<h2>Some of the work and status</h2>
		<table >
  				<tr>
   			 		<th>Work</th>
    				<th>Size</th>
				...
				<tr>
    					<td>The Virgin and Child with St. Anne</td>
    					<td>168 x 112 cm</td>
						<td>Universally accepted</td>
  				</tr>
				<tr>
				...
				<tr>
    					<td>Lucan Portrait of Leonardo da Vinci</td>
    					<td>40 x 60 cm</td>
	...
	<footer>
		<h2>Reference</h2>
		<ul>
			<li><a href="https://en.wikipedia.org/wiki/Leonardo_da_Vinci">1.Leonardo da Vinci. (2019, February 21). Retrieved from </a></li>
			<li><a href="https://www.britannica.com/biography/Leonardo-da-Vinci">2.Heydenreich, L. H. (2019, February 14). Leonardo da Vinci. Retrieved from </a></li>
		</ul>
	</footer>
</div><!--.container-->
<footer class="footer">
	...
	<div class="source"><a href = "http://www.csc170.org/span9/project1/">Content From</a></div>
	
</footer>
<?php include "inc/scripts.php";?>
<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-138971696-2"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-138971696-2');
</script>
</body>
